...
def main():
    ...
    mainurl = 'http://book.interpark.com/api/newBook.api?key='
    ...
    with open("interpark_new.json", "w", encoding="utf-8-sig") as f:
...
def insertmongoDB(list):
    ...
    #database 생성
    mydb = myclient['interparkBooks_new']  #interparkBooks
